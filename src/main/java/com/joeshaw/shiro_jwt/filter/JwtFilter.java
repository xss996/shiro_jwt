package com.joeshaw.shiro_jwt.filter;

import com.joeshaw.shiro_jwt.common.constant.GlobalConstant;
import com.joeshaw.shiro_jwt.shiro.JwtToken;
...
public class JwtFilter extends BasicHttpAuthenticationFilter {
    ...
    protected boolean executeLogin(ServletRequest request, ServletResponse response) throws ServletException, IOException {
        ...
        String token = httpServletRequest.getHeader(GlobalConstant.TOKEN_HEADER_NAME);
