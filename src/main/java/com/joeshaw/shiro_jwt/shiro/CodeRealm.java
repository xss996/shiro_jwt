package com.joeshaw.shiro_jwt.shiro;

import com.joeshaw.shiro_jwt.common.constant.GlobalConstant;
import com.joeshaw.shiro_jwt.common.util.RedisUtils;
...
public class CodeRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        Object credentials = redisUtils.get(GlobalConstant.REDIS_LOGIN_CODE + token.getUsername());
