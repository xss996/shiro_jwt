package com.joeshaw.shiro_jwt.common.util;
...
public class JwtUtils {
    ...
    public static boolean verify(String token, String secret) {
        try {
            ...
            JWTVerifier verifier = JWT.require(algorithm)
                    .withClaim(GlobalConstant.TOKEN_CLAIM, getUserId(token))
                    .build();
            // 效验TOKEN
    ...
    public static String getUserId(String token) {
        try {
            ...
            return jwt.getClaim(GlobalConstant.TOKEN_CLAIM).asString();
    ...
    public static String sign(String userId, String secret) {
        ...
        Algorithm algorithm = Algorithm.HMAC256(secret);
        return JWT.create()
                .withClaim(GlobalConstant.TOKEN_CLAIM, userId)
                .withExpiresAt(date)
                .sign(algorithm);
